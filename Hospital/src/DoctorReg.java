...
public class DoctorReg extends HttpServlet {
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			String qr = "insert into doctor(name,dob,qualification,specialist,email,mobile,password) values(?,?,?,?,?,?,?)";
			...
			if(i>0)
			{
				...
				out.println("<script>window.alert('Doctor added successfully');</script>");
			}
			else
			{
